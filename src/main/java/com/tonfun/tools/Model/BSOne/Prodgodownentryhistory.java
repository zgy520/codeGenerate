...
public class Prodgodownentryhistory{
  private static final Logger LOGGER = LoggerFactory.getLogger(Prodgodownentryhistory.class);
  @Id
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    if(!(o instanceof Prodgodownentryhistory)) return false;
    Prodgodownentryhistory prodgodownentryhistory= (Prodgodownentryhistory)o;
    return recordID!= null && recordID.equals(prodgodownentryhistory.recordID);
  }
  /**
  * 
  */
