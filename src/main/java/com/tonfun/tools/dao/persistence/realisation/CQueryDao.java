 ...
 * 
 * =======================================================================================*/
public class CQueryDao<T,ID extends Serializable> extends CCRUDDao<T, ID> implements IQueryDao<T, ID> {
	
	public List<T> findByColumnName(String columnName,String columnVal){
		return null;
	}
